             ...
             while (false !== ($file = readdir($handle))){
				 ...
				 {     
	               ...
	               $filename_array=explode(".",$file);
		            ...
		            if($filename_array[0]==$_POST['filename']){
							         ...
							         for($x=0;$x<=count($list1);$x++){
								          if($_POST['student_id']==$list1[$x][0][$key]){
										   ...
										   for($el=0;$el<=count($first_part);$el++){
											   ...
											   $show.='<th style="border: 1px solid black;">'.$first_part[$el].'</th>';
										   }
										   ...
										   for($el=0;$el<=count($list1[$x][0]);$el++){
											   ...
											   $show.='<td style="border: 1px solid black;"> '.$list1[$x][0][$el].'</td>';
										   }
										   $show.='</tr>';
